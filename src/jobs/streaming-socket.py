                ...
                for line in file:
                    ...
                    if (len(records)) == chunk_size:
                        ...
                        for record in chunk.to_dict(orient='records'):
                            serialize_data = json.dumps(record).encode('utf8')
...
if __name__ == '__main__':
    send_data_over_socket("/Users/khushiesharma/Documents/Kabir shit/RealtimeStreaming/src/datasets/yelp_academic_dataset_review.json")